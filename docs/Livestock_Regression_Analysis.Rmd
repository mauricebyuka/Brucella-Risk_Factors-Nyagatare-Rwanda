...
```{r}
data <- read.csv('Livestock_regression_data.csv') # Output of the previous step
```
...
ggplot(odds_data, aes(x = reorder(term, odds_ratio), y = odds_ratio, ymin = lower_ci, ymax = upper_ci, color = significant)) +
