...
```{r message = FALSE, warning = FALSE}
variables <- c("Age", "Sex", "Breed", "sector", "animals_live_with_people", "farm_fenced", "wildlife_interaction", "shared_water", "breeding_methods", "having_vet", "buryingAbort", "animalFeedAbort", "throwingAbort", "new_introduction", "brucellosis_awareness")
